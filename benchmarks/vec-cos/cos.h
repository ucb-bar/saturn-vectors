...
static inline vfloat64m##m##_t __cos_f64m##m(vfloat64m##m##_t x, size_t gvl) {  \
  ...
  x = __riscv_vreinterpret_v_i64m##m##_f64m##m(__riscv_vand_vx_i64m##m(__riscv_vreinterpret_v_f64m##m##_i64m##m(x), \
  ...
  emm2 = __riscv_vmerge_vxm_i64m##m(__riscv_vmv_v_x_i64m##m(_Zero, gvl), 0xffffffffffffffff, xMask, gvl); \
                                                                        \
  ...
  z = __riscv_vfmul_vv_f64m##m(x, x, gvl);                              \
                                                                        \
  y = __riscv_vfmacc_vf_f64m##m(__riscv_vfmv_v_f_f64m##m(_ps_coscof_p1, gvl), _ps_coscof_p0, y, gvl); \
  y = __riscv_vfmacc_vv_f64m##m(__riscv_vfmv_v_f_f64m##m(_ps_coscof_p2, gvl), z, y, gvl); \
  ...
  vfloat64m##m##_t y2;                                                  \
                                                                        \
  y2 = __riscv_vfmacc_vf_f64m##m(__riscv_vfmv_v_f_f64m##m(_ps_sincof_p1, gvl), _ps_sincof_p0, z, gvl); \
  y2 = __riscv_vfmacc_vv_f64m##m(__riscv_vfmv_v_f_f64m##m(_ps_sincof_p2, gvl), z, y2, gvl); \
  ...
  y2 = __riscv_vreinterpret_v_i64m##m##_f64m##m(__riscv_vand_vv_i64m##m(t1, t2, gvl)); \
  y = __riscv_vreinterpret_v_i64m##m##_f64m##m(__riscv_vand_vv_i64m##m(t4, t3, gvl)); \
  ...
  y = __riscv_vreinterpret_v_i64m##m##_f64m##m(__riscv_vxor_vv_i64m##m(t1, t2, gvl)); \
                                                                        \
  return y;                                                             \
}                                                                       \
