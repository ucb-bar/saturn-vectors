...
class ExecuteSequencer(implicit p: Parameters) extends PipeSequencer()(p) {
  val decode_table = Seq(
    ...
    (OPFFunct6.vfwadd   , Seq(Y,N,N)),
    (OPFFunct6.vfwsub   , Seq(Y,N,N)),
    (OPFFunct6.vfwaddw  , Seq(Y,Y,N)),
    (OPFFunct6.vfwsubw  , Seq(Y,Y,N)),
    (OPFFunct6.vfwmul   , Seq(Y,N,N)),
    (OPFFunct6.vfwmacc  , Seq(Y,N,N)),
    (OPFFunct6.vfwnmacc , Seq(Y,N,N)),
    (OPFFunct6.vfwmsac  , Seq(Y,N,N)),
    (OPFFunct6.vfwnmsac , Seq(Y,N,N)),
  )
