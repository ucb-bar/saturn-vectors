...
object ADC      extends OPIInstruction { val props = Seq(F6(OPIFunct6.adc)     , Sub.N, Averaging.N, CarryIn.Y, AlwaysCarryIn.N, SetsWMask.N) }
object MADC     extends OPIInstruction { val props = Seq(F6(OPIFunct6.madc)    , Sub.N, Averaging.N, CarryIn.Y, AlwaysCarryIn.Y, SetsWMask.N) }
object SBC      extends OPIInstruction { val props = Seq(F6(OPIFunct6.sbc)     , Sub.Y, Averaging.N, CarryIn.Y, AlwaysCarryIn.N, SetsWMask.N, WritesAsMask.Y) }
object MSBC     extends OPIInstruction { val props = Seq(F6(OPIFunct6.msbc)    , Sub.Y, Averaging.N, CarryIn.Y, AlwaysCarryIn.Y, SetsWMask.N, WritesAsMask.Y) }
...
object REDSUM   extends OPMInstruction { val props = Seq(F6(OPMFunct6.redsum)  , Reduction.Y, AccInitZeros.Y, Sub.N, Averaging.N, CarryIn.N) }
object WREDSUM  extends OPIInstruction { val props = Seq(F6(OPIFunct6.wredsum) , Reduction.Y, AccInitZeros.Y, Sub.N, Averaging.N, CarryIn.N, WideningSext.Y, Wide2VD.Y) }
object WREDSUMU extends OPIInstruction { val props = Seq(F6(OPIFunct6.wredsumu), Reduction.Y, AccInitZeros.Y, Sub.N, Averaging.N, CarryIn.N, WideningSext.N, Wide2VD.Y) }
...
object FREDOSUM  extends OPFInstruction { val props = Seq(F6(OPFFunct6.fredosum) , FPAdd.Y, FPMul.N, FPSwapVdV2.N, FPFMACmd(0.U(2.W)), Reduction.Y, AccInitZeros.Y) }
