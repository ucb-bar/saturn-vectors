...
object FCLASS_V  extends VectorInstruction { val props = Seq(F6(OPFFunct6.funary1)  , F3(VectorConsts.OPFVV), RS1(16.U(5.W)), FPSwapVdV2.N, FPSpecRM(1.U(3.W))) }

object FMIN      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.fmin)     , FPComp.Y, FPCompMin.Y, FPSpecRM(0.U(3.W))) }
object FMAX      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.fmax)     , FPComp.Y, FPCompMin.N, FPSpecRM(1.U(3.W))) }
object FSGNJ     extends OPFInstruction    { val props = Seq(F6(OPFFunct6.fsgnj)    , FPSgnj.Y, FPSpecRM(0.U(3.W))) }
object FSGNJN    extends OPFInstruction    { val props = Seq(F6(OPFFunct6.fsgnjn)   , FPSgnj.Y, FPSpecRM(1.U(2.W))) }
object FSGNJX    extends OPFInstruction    { val props = Seq(F6(OPFFunct6.fsgnjx)   , FPSgnj.Y, FPSpecRM(2.U(3.W))) }
object MFEQ      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mfeq)     , WritesAsMask.Y, FPMEQ.Y, FPMNE.N, FPMLT.N, FPMGT.N, FPSpecRM(2.U(3.W))) }
object MFNE      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mfne)     , WritesAsMask.Y, FPMEQ.N, FPMNE.Y, FPMLT.N, FPMGT.N, FPSpecRM(2.U(3.W))) }
object MFLT      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mflt)     , WritesAsMask.Y, FPMEQ.N, FPMNE.N, FPMLT.Y, FPMGT.N, FPSpecRM(1.U(3.W))) }
object MFLE      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mfle)     , WritesAsMask.Y, FPMEQ.Y, FPMNE.N, FPMLT.Y, FPMGT.N, FPSpecRM(0.U(3.W))) }
object MFGT      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mfgt)     , WritesAsMask.Y, FPMEQ.N, FPMNE.N, FPMLT.N, FPMGT.Y, FPSpecRM(0.U(3.W))) }
object MFGE      extends OPFInstruction    { val props = Seq(F6(OPFFunct6.mfge)     , WritesAsMask.Y, FPMEQ.Y, FPMNE.N, FPMLT.N, FPMGT.Y, FPSpecRM(1.U(3.W))) }
