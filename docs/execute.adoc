...
Once an operation is issued by the sequencer, it is guaranteed to be free of further structural or data hazards as it proceeds down the pipeline VFU datapaths.
This eliminates the need for costly back-pressued operand or result queues.
